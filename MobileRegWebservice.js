		...
		if(req.body.mobile_number != null && req.body.mobile_number != '')
		{
			...
			function(err, result) {
				...
				else
				{
					...
					var param1 = 'IVL_Error_Log__c';
					var param2 = 'IVL_API_Name__c=mobileregistration,IVL_Is_Error_Exception__c=false,IVL_Contact__c='+contactId+',IVL_Request__c='+requestBody+',IVL_Response__c='+jsonApiResponse+',IVL_Type__c= inbound';
					var queryData="SELECT INSERT_OPERATION(\'"+param1+"\',\'"+param2+"\')";
